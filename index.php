...
if(isset($_POST['slogin']))
{
	...
	$query="select * from student WHERE sroll_no='$srollno' AND spassword='$spassword'";
...
if(isset($_POST['plogin']))
{
	...
	$query="select * from professor WHERE pid='$p_no' AND ppassword='$ppassword'";
	$query_run=mysqli_query($con,$query);
	if(mysqli_num_rows($query_run)>0)
	{
		$_SESSION['pid']= $p_no;
...
if(isset($_POST['alogin']))
{
	...
	$query="select * from admin WHERE aid='$a_no' AND apassword='$apassword'";
	$query_run=mysqli_query($con,$query);
	if(mysqli_num_rows($query_run)>0)
	{
		$_SESSION['aid']= $a_no;
